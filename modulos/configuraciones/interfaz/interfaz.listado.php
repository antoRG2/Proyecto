    ...
    <head>
        ...
        <title>Sistema</title>
	        ...
	        <link rel="stylesheet" type="text/css" 
                href="../../../CSS/listarConfiguraciones.css">
	        <link rel="stylesheet" type="text/css" 
    ...
    <body>
        ...
        <div class="transBack">
            ...
            <div class="displayTable">
                <table id="tlistado" border="1" cellpadding="0" 
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php if($objConf -> get_UsuarioID($i) == 
                                $usuario){?>
	                        
                                <a href="interfaz.modificar.php?ConfID=<?=$objConf ->
                                get_ID($i)?>" title="Editar Configuracion">
                                <img src="../../../CSS/img/Editar.png" /></a></td>

	                        <?php }
                                else{?>
                                     No se puede modidicar la 
                                    configuraci&oacute;n <?php 
                                }?>
	                        
                            <td><?php if($objConf -> get_UsuarioID($i) ==
                                $usuario){?>
	                        <a href="javascript:Eliminar(<?=$objConf -> get_ID($i)?>);"
                                 title="Eliminar Configuracion"><img 
                                     src="../../../CSS/img/Eliminar.png" /></a></td>
	                        <?php }
                                else{?> 
                                No se puede eliminar la configuraci&oacute;n <?php }?>
	                        </tr>
                        <?php }?>
                    </tbody>
                </table>
                ...
                <a href="interfaz.agregar.php" title="Crear Configuraci&oacute;n">
                    <img src="../../../CSS/img/Nuevo.png"/>
                    <p>Agregar Configuraci&oacute;n</p></a>
