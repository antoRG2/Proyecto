			...
			$(function() {
				...
				$("#btnGuardar").click(function(){
					...
					var request = jQuery.ajax({
						...
						data: "id=<?=$ConfID?>&editar=1&dataJSON=" + dataJSON + '&nombre=' + encodeURIComponent($('#nombre').val()) + '&descripcion=' + encodeURIComponent($('#descripcion').val()) + '&pub=' + pub,//data
						async:false
					});
				...
				<div class="dragDropContainer">
					...
					<div id="drop">
						...
						<div class="ui-widget-content">
							<ol>
								<?php 
								for($i = 0; $i < $objConf->get_ContadorItems(); $i++){?>
									<li id="<?=$objConf -> get_ItemsID($i)?>"><?=$objConf -> get_ItemsName($i,"HTML")?></li>
								<?php }?>
							</ol>
						</div>
					</div>
