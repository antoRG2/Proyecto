			        ...
			        <table>
				        ...
				        <tr>
					        ...
					        <td><select name="tipo" id="tipo" class="scheck">
						        <option value="0" selected>...</option>
						        <option value="1">Seleci&oacute;n &Uacute;nica
						        </option>
				        ...
				        <tr>
					        ...
					        <td id='tdEnunciado1' style="display: none"><input 
                                type="file" name='enunciadoImg' id='enunciadoImg'/>
					        </td>
					        <td id='tdEnunciado2' style="display: none; width: 500px;">
                                <input type="text" name='enunciadoTxt' 
                                    id='enunciadoTxt'/></td>
					        <td id='tdEnunciado3' style="display: none">
                                <input type="file" 
                                name='enunciadoAudio' id='enunciadoAudio'/></td>
				        </tr>
				        <tr>
					        <td><label for="descripcion">Descripci&oacute;n:</label>
					        </td>
					        <td><textarea id="descripcion" name="descripcion"
                                 style="width: 500px;height: 66px;"></textarea></td>
				        </tr>
				        <tr>
					        <td><label for='areaC'>&Aacute;rea de Conocimiento:
					            </label></td>
					        <td><?=$objArea -> _HTML_SELECT()?></td>
				        </tr>
				        <tr>
					        <td><label for="nRespuestas">Cantidad de Respuestas:
					            </label></td>
					        <td><input type='text' readonly size='2' value="2"  
