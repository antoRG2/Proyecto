...
$objConf -> set_Cedula($usuario); //$usuario es la variable de sesion que representa la cédual de la persona que esta logeada.
...
<body>
    <div class="backgroundTransparent">
            ...
            <?php
                ...
                {?>
                <li>
                    <a href="ejecutar.pruebas.php?id=<?=$objConf ->get_EstudianteConfID($i)?>&test=<?=$objConf ->get_ID($i)?>"><?=$objConf ->get_Nombre($i,"HTML")?></a>
                </li>
            <?php }?>
            </ul>
            <br />
