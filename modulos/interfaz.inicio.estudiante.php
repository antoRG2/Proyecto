...
require_once $_SERVER['DOCUMENT_ROOT'].'/Sistema/modulos/estudiantes/modelo/clase.estudiantes.php';

require_once $_SERVER['DOCUMENT_ROOT'].'/Sistema/modulos/profesores/modelo/clase.profesores.php';
	...
	<div class="backgroundTransparent">
		<h1>
            ...
            <?php
                ...
                {?>
                <li>
                    <a href="pruebas/lista.pruebas.php?profesor=<?=$objP ->get_Cedula(0)?>"><?=$objP -> get_Nombre($i, "HTML")?></a>
                </li>
            <?php }?>
            </ul>
	</div>
