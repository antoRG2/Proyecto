	 		    ...
	 		    $("#buscar").click(function(){
				    ...
				    if(json.length == 0){
				        ...
				        for(i = 0; i < json.length; i++){
				            ...
				            data = '1,' + json[i]['cedula'] + ',' + json[i]['nombre'] + ','
                                                                     + json[i]['seccion'];

				            options += "<option value='" + data + "'>" + json[i]['cedula']
                ...
                $("#cedula").keyup(function(){	 			
	 		    ...
	 		    $("#btnGuardar").click(function(){
	 		        ...
	 		        if ($('#validador').val() == 1)
                    {
                        ...
                        if(id > 0){
                            if(nomORG != nom){
                                if (!confirm('Al cambiar el nombre del estudiante, '
                                  + 'se cambia tambien el nombre de usuario aisgnado al mismo. \n\n\
                                            ¿Desea continuar?')) {
                                    return false;
                                }
                            }
                        ...
                        request.done(function(msg){
                            ...
                            if(msg == -1) {
                                alert('El estudiante seleccionado ya se encuentra'
                                            + ' registrado para su usuario.');
	 		            ...
	 		            // seleccionado ningún estudiante o que sea un 
                        //registro nuevo.
                        $('#btnModificar').hide();
                    }
	 		    });
		        ...
		        <div class="displayTable">
			        <form name="FRMbusqueda"  id="FRMbusqueda" >
			            <table>
				            ...
				            <tr>
					            <td colspan="2" align="rigth"><input type="button" name="buscar" 
                                                        id="buscar" value="Buscar" /></td>
				            </tr>
			            </table>
			        </form>
			        <br />
