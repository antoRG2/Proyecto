 ...
 */
 ...
 (function($){
	...
	$.fn.tablePagination = function(settings) {
		var defaults = {  
			firstArrow : (new Image()).src="../../../CSS/img/paginacion/first.gif",  
			prevArrow : (new Image()).src="../../../CSS/img/paginacion/prev.gif",
			lastArrow : (new Image()).src="../../../CSS/img/paginacion/last.gif",
			nextArrow : (new Image()).src="../../../CSS/img/paginacion/next.gif",
			rowsPerPage : 10,
			currPage : 1,
